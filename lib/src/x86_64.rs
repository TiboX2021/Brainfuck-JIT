...
//! jz xxx          ; 0x0f 0x84 0xff 0xff 0xff 0xff 0xff
//! ```
...
//! mov rax, [r13]  ; 0x49 0x8B 0x45 0x00
//! test al, al     ; 0x84 0xc0
//! jnz xxx          ; 0x0f 0x85 0xff 0xff 0xff 0xff 0xff
//! ```
//! The last `0xff` instructions will need to be replaced with the actual offset.
    ...
    fn from(instruction: &Instruction) -> Self {
        match instruction {
            ...
            Instruction::JumpBackwards => &[
                0x49, 0x8b, 0x45, 0x00, 0x84, 0xc0, 0x0f, 0x85, 0xff, 0xff, 0xff, 0xff, 0xff,
            ],
            Instruction::JumpForward => &[
                0x49, 0x8b, 0x45, 0x00, 0x84, 0xc0, 0x0f, 0x84, 0xff, 0xff, 0xff, 0xff, 0xff,
            ],
            Instruction::Output => &[
